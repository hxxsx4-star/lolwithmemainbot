...
CHAMPIONS: dict[str, ChampionSpec] = {
    # ------------------------------------------------------------------ 탑
    "DARIUS": ChampionSpec("Darius", "TOP", (176, 48, 48), (255, 120, 96)),
    "RIVEN": ChampionSpec("Riven", "TOP", (110, 200, 190), (200, 250, 240)),
    "AATROX": ChampionSpec("Aatrox", "TOP", (198, 52, 52), (240, 200, 200)),
    "TEEMO": ChampionSpec("Teemo", "TOP", (110, 200, 120), (230, 200, 90)),
    "GAREN": ChampionSpec("Garen", "TOP", (86, 148, 216)),
    "FIORA": ChampionSpec("Fiora", "TOP", (196, 88, 120)),
    "JAX": ChampionSpec("Jax", "TOP", (150, 130, 200)),
    "NASUS": ChampionSpec("Nasus", "TOP", (216, 176, 96)),
    "ORNN": ChampionSpec("Ornn", "TOP", (208, 100, 56)),
    "KENNEN": ChampionSpec("Kennen", "TOP", (232, 206, 88)),
    "IRELIA": ChampionSpec("Irelia", "TOP", (96, 190, 200)),
    "KSANTE": ChampionSpec("K'Sante", "TOP", (200, 176, 120)),
    # --------------------------------------------------------------- 정글
    "LEESIN": ChampionSpec("Lee Sin", "JG", (208, 132, 64), (250, 200, 120)),
    "MASTERYI": ChampionSpec("Master Yi", "JG", (216, 190, 100), (150, 230, 190)),
    "VIEGO": ChampionSpec("Viego", "JG", (100, 200, 176), (170, 130, 220)),
    "KINDRED": ChampionSpec("Kindred", "JG", (168, 216, 200), (240, 240, 250)),
    "WARWICK": ChampionSpec("Warwick", "JG", (120, 160, 200)),
    "JARVANIV": ChampionSpec("Jarvan IV", "JG", (216, 180, 96)),
    "GRAVES": ChampionSpec("Graves", "JG", (176, 130, 96)),
    "NIDALEE": ChampionSpec("Nidalee", "JG", (200, 170, 100)),
    "XINZHAO": ChampionSpec("Xin Zhao", "JG", (196, 88, 88)),
    "HECARIM": ChampionSpec("Hecarim", "JG", (120, 200, 168)),
    "ELISE": ChampionSpec("Elise", "JG", (176, 96, 176)),
    "RENGAR": ChampionSpec("Rengar", "JG", (200, 140, 90)),
    # ---------------------------------------------------------------- 미드
    "YASUO": ChampionSpec("Yasuo", "MID", (100, 180, 230), (200, 240, 255)),
    "ZED": ChampionSpec("Zed", "MID", (200, 60, 72), (110, 120, 150)),
    "AHRI": ChampionSpec("Ahri", "MID", (232, 120, 176), (255, 200, 230)),
    "YONE": ChampionSpec("Yone", "MID", (150, 130, 220), (240, 130, 140)),
    "LEBLANC": ChampionSpec("LeBlanc", "MID", (176, 120, 216)),
    "SYNDRA": ChampionSpec("Syndra", "MID", (168, 120, 224)),
    "AZIR": ChampionSpec("Azir", "MID", (230, 196, 100)),
    "KATARINA": ChampionSpec("Katarina", "MID", (216, 72, 96)),
    "TALON": ChampionSpec("Talon", "MID", (150, 160, 190)),
    "ORIANNA": ChampionSpec("Orianna", "MID", (140, 190, 210)),
    "VIKTOR": ChampionSpec("Viktor", "MID", (196, 150, 80)),
    "AKALI": ChampionSpec("Akali", "MID", (110, 210, 160)),
    # ---------------------------------------------------------------- 원딜
    "JHIN": ChampionSpec("Jhin", "AD", (216, 96, 120), (240, 200, 160)),
    "JINX": ChampionSpec("Jinx", "AD", (216, 100, 176), (140, 200, 230)),
    "CAITLYN": ChampionSpec("Caitlyn", "AD", (130, 170, 220), (230, 190, 120)),
    "EZREAL": ChampionSpec("Ezreal", "AD", (230, 200, 110), (120, 200, 230)),
    "ASHE": ChampionSpec("Ashe", "AD", (140, 200, 230)),
    "VAYNE": ChampionSpec("Vayne", "AD", (170, 130, 200)),
    "MISSFORTUNE": ChampionSpec("Miss Fortune", "AD", (216, 110, 90)),
    "XAYAH": ChampionSpec("Xayah", "AD", (200, 90, 130)),
    "LUCIAN": ChampionSpec("Lucian", "AD", (200, 180, 140)),
    "KALISTA": ChampionSpec("Kalista", "AD", (110, 200, 190)),
    "SIVIR": ChampionSpec("Sivir", "AD", (216, 170, 90)),
    "KOGMAW": ChampionSpec("Kog'Maw", "AD", (150, 200, 110)),
    # ---------------------------------------------------------------- 서폿
    "THRESH": ChampionSpec("Thresh", "SUP", (110, 210, 170), (180, 250, 220)),
    "LEONA": ChampionSpec("Leona", "SUP", (230, 180, 90), (255, 230, 160)),
    "PYKE": ChampionSpec("Pyke", "SUP", (90, 200, 200), (170, 120, 210)),
    "YUUMI": ChampionSpec("Yuumi", "SUP", (230, 170, 200), (180, 220, 250)),
    "LULU": ChampionSpec("Lulu", "SUP", (190, 150, 230)),
    "NAMI": ChampionSpec("Nami", "SUP", (110, 190, 220)),
    "SORAKA": ChampionSpec("Soraka", "SUP", (170, 200, 230)),
    "BLITZCRANK": ChampionSpec("Blitzcrank", "SUP", (196, 160, 90)),
    "BRAUM": ChampionSpec("Braum", "SUP", (150, 180, 220)),
    "MORGANA": ChampionSpec("Morgana", "SUP", (170, 120, 210)),
    "ALISTAR": ChampionSpec("Alistar", "SUP", (196, 130, 110)),
    "SENNA": ChampionSpec("Senna", "SUP", (140, 200, 180)),
}
