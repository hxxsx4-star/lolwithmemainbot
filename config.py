...
# 반응 이벤트에는 이모지 ID 만 실려 오므로 역방향 표도 만들어 둔다
LANE_BY_EMOJI_ID: dict[int, str] = {
    1536155329476436048: "TOP",
    1536155353748738088: "JG",
    1536155379329662996: "MID",
    1536155402683547748: "AD",
    1536155432459051028: "SUP",
}
